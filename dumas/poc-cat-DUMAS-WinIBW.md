...
Il est fortement recommandé d'utiliser [le court script `delEspaceB4Tag()`](../../../../WinIBW/tree/main/scripts.md#delespaceb4tag) après avoir collé la notice afin de supprimer les espaces en trop :

[Voir le fichier contenant le script dans mon dépôt WinIBW](../../../../WinIBW/tree/main/scripts/vbs/alp_dumas.vbs).
